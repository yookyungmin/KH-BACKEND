	...
	public static void main(String[] args) throws Exception {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				String sql1 = "insert into cafe_menu values(Cafe_menu_seq.nextval,'"+pname+"',"+pprice+",'"+iced+"')";
				...
				String sql = "delete from cafe_menu where pid =" +pid+""; //sql 삭제쿼리
				...
				int ppid = Integer.parseInt(sc.nextLine());
				...
				String sql = "update cafe_menu set pid = "+ppid+", pname ='"+ name+"',pprice ="+ pprice+",iced='"+iced+"'"
						+ "where pid = "+pid+""; //sql 업데이트쿼리
