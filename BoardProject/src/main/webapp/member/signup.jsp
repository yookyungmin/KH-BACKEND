...
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
    ...
    <style>
        *{box-sizing: border-box;}
        ...
        div:not(.resultval) {border: 1px solid black;}
        ...
        .header{width: 100%; height: 70px; text-align: center; text-align: center; font-weight: 800;}

        .contents{width: 100%; height: 450px;}

        .row{width: 100%; height: 50px;}

        .row>div{float: left; height: 100%;}

        .title{width: 20%; line-height: 45px; text-align: right; padding-right: 20px;}
        .box1{width: 40%;}
        .box2{width: 40%; line-height: 45px; padding-left: 20px}
        .box3{width: 80%; line-height: 45px;}

        .footer{
            width: 100%; height: 70px; text-align: center; line-height: 65px; }
...
<body>
  <form action="/toJoin.mem" method ="post" id="frm">
    <div class="container">
        <div class="header"><h1>회원가입 정보 입력</h1></div>
        ...
        <div class="contents">
            ...
            <div class="row">
                ...
                <div class="box1"><input type="text" name="pw" id="inputPw" placeholder="사용하실 pw를 입력하세요"></div>
                <div class="box2">
            ...
            <div class="row">
                ...
                <div class="box1"><input type="text"  id="inputPw2" placeholder="사용하실 pw를 한번더 입력"></div>
                <div class="box2"></div>
            </div>
            <div class="row">
                <div class="title">이름 :</div>
                <div class="box1"><input type="text" name="name" id="inputName" placeholder="사용하실 이름을 입력하세요"></div>
                <div class="box2"></div>
        
            </div>
            <div class="row">
                <div class="title">전화번호 :</div>
                <div class="box1"><input type="text" name="phone" id="inputPhone" placeholder="사용하실 전화번호 입력하세요"></div>
                <div class="box2">
            ...
            <div class="row">
                ...
                <div class="box1"><input type="text" name="email" id="inputem" placeholder="사용하실 이메일 입력하세요"></div>
                <div class="box2">
            ...
            <div class="row">
                ...
                <div class="box1"><input type="text" name="zipcode" id="postcode"></div>
                <div class="box2" id="post" ><button type="button" id="postsearch" >찾기</button></div>
            </div>
            <div class="row">
                <div class="title">주소1 :</div>
                <div class="box3"><input type="text" name="address1" id="address1" ></div>
            </div>
            <div class="row">
                <div class="title">상세주소 :</div>
                <div class="box3"><input type="text" name="address2" id="address2" ></div>
            </div>
        </div>
