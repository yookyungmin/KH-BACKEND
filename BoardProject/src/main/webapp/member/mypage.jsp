...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
  ...
  <style>
        ...
        <body>
            <form action="/toUpdate.mem" method="post" id="frm">
                <div class="container">
                    <div class="header">
                        <h1>마이페이지</h1>
                    </div>
                    ...
                    <div class="contents">
                        <div class="row">
                          ...
                          <div class="box1"><input type="text" name="id" id="inputId" disabled value="${list.id}"></div>
                         <div class="box2"></div>
                        </div>
                        <div class="row">
                            <div class="title">패스워드 :</div>
                            <div class="box1"><input type="text" name="pw" id="inputPw" placeholder="input your pw" readonly>
                            </div>
                            <div class="box2">
                        ...
                        <div class="row">
                            ...
                            <div class="box1"><input type="text" id="inputPw2" placeholder="사용하실 pw를 한번더 입력" readonly></div>
                            <div class="box2"></div>
                        </div>
                        <div class="row">
                            <div class="title">이름 :</div>
                          
                            <div class="box1"><input type="text" name="name" id="inputName"
                         	  placeholder="input your name" value="${list.name}" readonly></div>
                        ...
                        <div class="row">
                            ...
                            <div class="box1"><input type="text" name="phone" id="inputPhone"
                        ...
                        <div class="row">
                            ...
                            <div class="box1"><input type="text" name="email" id="inputem" placeholder="사용하실 이메일 입력하세요" value="${list.email}" readonly>
                            </div>
                            <div class="box2">
                        ...
                        <div class="row">
                            ...
                            <div class="box1"><input type="text" name="zipcode" id="postcode" value="${list.zipcode}" readonly></div>
                            <div class="box2"  style="display:none" id="searchpost"><button type="button" id="postsearch">찾기</button></div>
                        </div>
                        <div class="row">
                            <div class="title">주소1 :</div>
                            <div class="box3"><input type="text" name="address1" id="address1" value="${list.address1}" readonly></div>
                        </div>
                        <div class="row">
                            <div class="title">상세주소 :</div>
                           <div class="box3"><input type="text" name="address2" id="address2" value="${list.address2}" readonly ></div>
                        </div>

                         <div class="row">
                            <div class="title">회원가입 날짜</div>
                            <div class="box3"><fmt:formatDate pattern="yyyy년 MM월 dd일 가입" value="${list.signup_date}"/></div>
                        </div>
                    </div>
            			 
				<div class="footer" id="btns">
           		    <button type="button" id="modify">정보수정</button>
                    <a href="/index.jsp"><button type="button" id="toHome">홈으로</button></a>
