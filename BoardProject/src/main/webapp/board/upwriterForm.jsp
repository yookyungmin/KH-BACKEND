<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                <form action="/update.board"method="post" id="form">
                <div class="container">
                    <div class="row header">
              <div class="d-none" id="seq"><input name="seq" value="${list.seq}">${list.seq}</div> 
                        <div class="col-12 col-md-12"><input type="text" name="uptitle" value="${list.title}" ></div>
                    ...
                    <div class="row contents">
                        <div class="col-12">
                           <!--  <input type="textarea" name="upcontents" value="${list.contents }"> -->
                        	<textarea  name="upcontents">${list.contents }</textarea>	
                        </div>
                    </div>
